    ...
    public partial class all : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoaiBans", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idLoaiBan = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    OrderIDCurent = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tables", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tables_KhuVucs_idKhuVuc",
                        column: x => x.idKhuVuc,
                        principalTable: "KhuVucs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tables_LoaiBans_idLoaiBan",
                        column: x => x.idLoaiBan,
                        principalTable: "LoaiBans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tables_idKhuVuc",
                table: "Tables",
                column: "idKhuVuc");

            migrationBuilder.CreateIndex(
                name: "IX_Tables_idLoaiBan",
                table: "Tables",
                column: "idLoaiBan");
        }
